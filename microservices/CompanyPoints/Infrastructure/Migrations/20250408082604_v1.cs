        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyPoints_Localities_LocalityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_CompanyPoints_PointId",
                        column: x => x.PointId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkingHours_CompanyPoints_PointId",
                        column: x => x.PointId,
                        principalTable: "CompanyPoints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyPoints_Coordinates",
                table: "CompanyPoints",
                column: "Coordinates")
                .Annotation("Npgsql:IndexMethod", "GIST");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyPoints_LocalityId",
                table: "CompanyPoints",
                column: "LocalityId");

            migrationBuilder.CreateIndex(
                name: "IX_Contacts_PointId",
                table: "Contacts",
                column: "PointId");
